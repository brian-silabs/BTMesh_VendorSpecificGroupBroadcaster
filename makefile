...
# Only add named socket on Posix system
ifeq ($(OS),posix)
INCLUDEPATHS += \
-I$(SDK_DIR)/app/bluetooth/common_host/named_socket
endif
...
#NOTE: Define BTMESH here so common code knows mesh specific sources have to be compiled
...
ifeq ($(OS),posix)
C_SRC += \
$(SDK_DIR)/app/bluetooth/common_host/named_socket/named_socket.c
endif
